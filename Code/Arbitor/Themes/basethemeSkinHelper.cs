...
namespace Syncfusion.Themes.basetheme.WPF
{
    /// <exclude/>
    public class basethemeSkinHelper : SkinHelper
    {
        ...
        {
            string rootStylePath = "/Syncfusion.Themes.basetheme.WPF;component/";
    ...
    /// </summary>
    public class basethemeThemeSettings: IThemeSetting
    {
        /// <summary>
        /// Constructor to create an instance of basethemeThemeSettings.
        /// </summary>
        public basethemeThemeSettings()
        {
        ...
        /// <code language="C#">
        /// <![CDATA[
        /// basethemeThemeSettings themeSettings = new basethemeThemeSettings();
		/// themeSettings.Palette = FluentPalette.PinkRed;
        /// SfSkinManager.RegisterThemeSettings("basetheme", themeSettings);
        /// ]]>
        /// </code>
        /// </example>
        /// <remarks>
		...
		/// <code language="C#">
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.HeaderFontSize = 16;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.SubHeaderFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.TitleFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.SubTitleFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.BodyFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.Body AltFontSize = 10;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.FontFamily = new FontFamily("Callibri");
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.PrimaryBackground = Brushes.Red;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// basethemeThemeSettings basethemeThemeSettings = new basethemeThemeSettings();
		/// basethemeThemeSettings.PrimaryForeground = Brushes.AntiqueWhite;
		/// SfSkinManager.RegisterThemeSettings("basetheme", basethemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
