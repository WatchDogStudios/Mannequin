...
set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_WEB ON)
set_property(GLOBAL PROPERTY NS_CMAKE_PLATFORM_SUPPORTS_WEBGPU ON)

macro(ns_platform_pull_properties)

	get_property(NS_CMAKE_PLATFORM_WEB GLOBAL PROPERTY NS_CMAKE_PLATFORM_WEB)
...
macro(ns_platform_detect_generator)
	if(CMAKE_GENERATOR MATCHES "Ninja" OR CMAKE_GENERATOR MATCHES "Ninja Multi-Config")
		...
		message(FATAL_ERROR "Generator '${CMAKE_GENERATOR}' is not supported on Web! Please extend ns_platform_detect_generator()")
	endif()
endmacro()
...
macro (ns_platformhook_set_build_flags_clang TARGET_NAME)
	...
	target_compile_options(${TARGET_NAME} PRIVATE 
		...
		# Debug Build
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEBUG_UPPER}>:-gsource-map>"
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEBUG_UPPER}>:-g3>"
		
		# Dev Build
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEV_UPPER}>:-gsource-map>"
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEV_UPPER}>:-g2>"
		
		# Shipping Build
		"$<$<CONFIG:${NS_BUILDTYPENAME_SHIPPING_UPPER}>:-g0>"
	)
...
macro(ns_platformhook_set_application_properties TARGET_NAME)
	...
	target_link_options(${TARGET_NAME} PRIVATE
		...
		# Debug Build
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEBUG_UPPER}>:-sSTACK_OVERFLOW_CHECK=1>"
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEBUG_UPPER}>:-sASSERTIONS=1>"
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEBUG_UPPER}>:-g3>"

		# Dev Build
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEV_UPPER}>:-sASSERTIONS=1>"
		"$<$<CONFIG:${NS_BUILDTYPENAME_DEV_UPPER}>:-g2>"
