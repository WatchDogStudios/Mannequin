...
// Specialization for nsUInt8
template <>
struct nsHashHelper<nsUInt8>
{
  NS_ALWAYS_INLINE static nsUInt32 Hash(nsUInt8 value)
  {
    // Use Knuth's multiplicative hash for 8-bit values
    return static_cast<nsUInt32>(value) * 2654435761U;
  }

  NS_ALWAYS_INLINE static bool Equal(nsUInt8 a, nsUInt8 b) { return a == b; }
};
