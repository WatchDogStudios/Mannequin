...
///
/// This is automatically called by NS_APPLICATION_ENTRY_POINT().
///
...
///
/// Finally pass the name of your derived class to the macro NS_APPLICATION_ENTRY_POINT().
...
public:
  ...
  NS_ALWAYS_INLINE bool ShouldApplicationQuit() const { return m_bWasQuitRequested; }
