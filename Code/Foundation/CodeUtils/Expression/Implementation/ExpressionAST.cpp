...
{
  NS_ASSERT_DEBUG(nodeType >= 0 && static_cast<nsUInt32>(nodeType) < NS_ARRAY_SIZE(s_szNodeTypeNames), "Out of bounds access");
...
{
  NS_ASSERT_DEBUG(dataType >= 0 && static_cast<nsUInt32>(dataType) < NS_ARRAY_SIZE(s_DataTypeVariantTypes), "Out of bounds access");
...
{
  NS_ASSERT_DEBUG(dataType >= 0 && static_cast<nsUInt32>(dataType) < NS_ARRAY_SIZE(s_szDataTypeNames), "Out of bounds access");
...
{
  NS_ASSERT_DEBUG(vectorComponent >= 0 && static_cast<nsUInt32>(vectorComponent) < NS_ARRAY_SIZE(s_szVectorComponentNames), "Out of bounds access");
...
nsExpressionAST::VectorComponent::Enum nsExpressionAST::VectorComponent::FromChar(nsUInt32 uiChar)
{
  ...
  {
    const nsUInt32 uiComponentName = s_szVectorComponentNames[i][0];
    const nsUInt32 uiComponentAltName = s_szVectorComponentAltNames[i][0];
