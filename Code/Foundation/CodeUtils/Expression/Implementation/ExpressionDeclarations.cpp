...
{
  NS_ASSERT_DEBUG(registerType >= 0 && static_cast<nsUInt32>(registerType) < NS_ARRAY_SIZE(s_szRegisterTypeNames), "Out of bounds access");
...
nsExpressionFunction nsDefaultExpressionFunctions::s_RandomFunc = {
  {nsMakeHashedString("Random"), nsExpression::FunctionDesc::TypeList(s_RandomInputTypes), 1, RegisterType::Float},
  &Random,
};

nsExpressionFunction nsDefaultExpressionFunctions::s_PerlinNoiseFunc = {
  {nsMakeHashedString("PerlinNoise"), nsExpression::FunctionDesc::TypeList(s_PerlinNoiseInputTypes), 3, RegisterType::Float},
  &PerlinNoise,
};
