...
#define DEFINE_CONSTANT(name)                                                      \
  const nsUInt32 NS_PP_CONCAT(name, Raw) = *pByteCode;                             \
  NS_IGNORE_UNUSED(NS_PP_CONCAT(name, Raw));                                       \
...
#define DEFINE_UNARY_OP(name, code)                                                      \
  void NS_PP_CONCAT(name, _4)(const ByteCodeType*& pByteCode, ExecutionContext& context) \
  {                                                                                      \
