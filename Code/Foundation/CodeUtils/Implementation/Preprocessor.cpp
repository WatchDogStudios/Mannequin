...
nsResult nsPreprocessor::ProcessFile(nsStringView sFile, TokenStream& TokenOutput, const nsToken* pCurParentToken)
{
...
{
  NS_IGNORE_UNUSED(uiDirectiveToken);
