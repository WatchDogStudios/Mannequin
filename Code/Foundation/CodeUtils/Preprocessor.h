...
private:
  ...
  nsResult ProcessFile(nsStringView sFile, nsTokenParseUtils::TokenStream& TokenOutput, const nsToken* pCurParentToken);
...
private: // *** Macro Definition ***
  ...
  {
    const nsToken* m_MacroIdentifier = nullptr;
    bool m_bIsFunction = false;
    bool m_bCurrentlyExpanding = false;
    bool m_bHasVarArgs = false;
    nsUInt32 m_uiNumParameters = nsInvalidIndex;
