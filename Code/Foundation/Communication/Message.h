...
public:
  ...
  virtual void Serialize(nsStreamWriter& inout_stream) const
  {
  ...
  /// \see Serialize()
  virtual void Deserialize(nsStreamReader& inout_stream, nsUInt8 uiTypeVersion)
  {
    NS_IGNORE_UNUSED(inout_stream);
    NS_IGNORE_UNUSED(uiTypeVersion);
    NS_ASSERT_NOT_IMPLEMENTED;
  }
