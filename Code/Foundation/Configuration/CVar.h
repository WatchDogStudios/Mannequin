...
public:
  ...
  using CVarEvents = nsEvent<const nsCVarEvent&, nsMutex, nsStaticsAllocatorWrapper>;
...
private:
  ...
  static void LoadCVarsFromFileInternal(nsStringView path, const nsDynamicArray<nsCVar*>& vars, bool bSetAsCurrentValue, nsDynamicArray<nsCVar*>* pOutCVars);
