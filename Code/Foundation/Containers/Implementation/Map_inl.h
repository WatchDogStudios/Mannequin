...
void nsMapBase<KeyType, ValueType, Comparer>::Constructor()
{
  ...
  m_NilNode.m_pLink[0] = reinterpret_cast<Node*>(&m_NilNode); //TODO: V717 https://pvs-studio.com/en/docs/warnings/v717/ It is suspicious to cast object of base class 'NilNode' to derived class 'Node'.
