...
{
  static_assert((int)nsOpenDdlWriter::State::PrimitivesBool == (int)nsOpenDdlPrimitiveType::Bool);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesInt8 == (int)nsOpenDdlPrimitiveType::Int8);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesInt16 == (int)nsOpenDdlPrimitiveType::Int16);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesInt32 == (int)nsOpenDdlPrimitiveType::Int32);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesInt64 == (int)nsOpenDdlPrimitiveType::Int64);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesUInt8 == (int)nsOpenDdlPrimitiveType::UInt8);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesUInt16 == (int)nsOpenDdlPrimitiveType::UInt16);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesUInt32 == (int)nsOpenDdlPrimitiveType::UInt32);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesUInt64 == (int)nsOpenDdlPrimitiveType::UInt64);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesFloat == (int)nsOpenDdlPrimitiveType::Float);
  static_assert((int)nsOpenDdlWriter::State::PrimitivesString == (int)nsOpenDdlPrimitiveType::String);
