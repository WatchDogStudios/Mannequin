...
/// analysis happy.
#define NS_LOG_BLOCK nsLogBlock NS_PP_CONCAT(_logblock_, NS_SOURCE_LINE)

/// \brief Use this helper macro to easily mute all logging in a scope.
#define NS_LOG_BLOCK_MUTE()                               \
  nsMuteLog NS_PP_CONCAT(_logmuteblock_, NS_SOURCE_LINE); \
  nsLogSystemScope NS_PP_CONCAT(_logscope_, NS_SOURCE_LINE)(&NS_PP_CONCAT(_logmuteblock_, NS_SOURCE_LINE))
