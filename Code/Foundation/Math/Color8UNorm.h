...
static_assert(sizeof(nsColorBaseUB) == 4);
...
public:
  ...
  static nsColorLinearUB MakeFromABGR8(nsUInt32 value)
  {
    return nsColorLinearUB(static_cast<nsUInt8>(value >> 0) & 0xFF,
      static_cast<nsUInt8>(value >> 8) & 0xFF,
      static_cast<nsUInt8>(value >> 16) & 0xFF,
      static_cast<nsUInt8>(value >> 24) & 0xFF);
  }
};

static_assert(sizeof(nsColorLinearUB) == 4);
...
static_assert(sizeof(nsColorGammaUB) == 4);
