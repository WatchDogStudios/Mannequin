...
inline nsColor nsColor::MakeFromKelvin(nsUInt32 uiKelvin)
{
  ...
  finalColor.r = kelvin < 6.570f ? 1.0f : nsMath::Saturate((1.35651f + 0.216422f * kelvin + 0.000633715f * kelvin2) / (-3.24223f + 0.918711f * kelvin));
  finalColor.g = kelvin < 6.570f ? nsMath::Saturate((-399.809f + 414.271f * kelvin + 111.543f * kelvin2) / (2779.24f + 164.143f * kelvin + 84.7356f * kelvin2)) : nsMath::Saturate((1370.38f + 734.616f * kelvin + 0.689955f * kelvin2) / (-4625.69f + 1699.87f * kelvin));
  finalColor.b = kelvin > 6.570f ? 1.0f : nsMath::Saturate((348.963f - 523.53f * kelvin + 183.62f * kelvin2) / (2848.82f - 214.52f * kelvin + 78.8614f * kelvin2));
