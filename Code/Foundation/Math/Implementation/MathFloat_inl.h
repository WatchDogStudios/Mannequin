...
namespace nsMath
{
  ...
  NS_ALWAYS_INLINE nsInt32 FloorToInt(float f)
  {
    return static_cast<nsInt32>(floorf(f));
  }
  ...
  NS_ALWAYS_INLINE nsInt32 CeilToInt(float f)
  {
    return static_cast<nsInt32>(ceilf(f));
  }
  ...
  NS_ALWAYS_INLINE nsInt32 RoundToInt(float f)
  {
