...
template <typename Type>
NS_IMPLEMENT_IF_FLOAT_TYPE NS_ALWAYS_INLINE Type nsVec2Template<Type>::GetDistanceTo(const nsVec2Template<Type>& rhs) const
{
  return (*this - rhs).GetLength();
}

template <typename Type>
NS_IMPLEMENT_IF_FLOAT_TYPE NS_ALWAYS_INLINE Type nsVec2Template<Type>::GetSquaredDistanceTo(const nsVec2Template<Type>& rhs) const
{
