...
template <typename Type>
NS_IMPLEMENT_IF_FLOAT_TYPE NS_ALWAYS_INLINE Type nsVec3Template<Type>::GetDistanceTo(const nsVec3Template<Type>& rhs) const
{
  return (*this - rhs).GetLength();
}

template <typename Type>
NS_IMPLEMENT_IF_FLOAT_TYPE NS_ALWAYS_INLINE Type nsVec3Template<Type>::GetSquaredDistanceTo(const nsVec3Template<Type>& rhs) const
{
