...
namespace nsIntersectionUtils
{
  ...
  NS_FOUNDATION_DLL bool RayTriangleIntersection(const nsVec3& vRayStartPos, const nsVec3& vRayDir, const nsVec3& vVertex0, const nsVec3& vVertex1, const nsVec3& vVertex2, float* out_pIntersectionTime = nullptr, nsVec3* out_pIntersectionPoint = nullptr); // [tested]
