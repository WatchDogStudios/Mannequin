...
public:
  ...
  NS_DECLARE_IF_FLOAT_TYPE
  Type GetDistanceTo(const nsVec3Template<Type>& rhs) const;

  /// \brief Returns the squared length between this position and rhs.
  NS_DECLARE_IF_FLOAT_TYPE
  Type GetSquaredDistanceTo(const nsVec3Template<Type>& rhs) const;
  ...
  NS_DECLARE_IF_FLOAT_TYPE
  [[nodiscard]] const nsVec3Template<Type> GetNormalized() const; // [tested]
...
public:
  ...
  [[nodiscard]] Type Dot(const nsVec3Template<Type>& rhs) const; // [tested]



  /// \brief Returns the Cross-product of the two vectors (NOT commutative, order DOES matter)
  [[nodiscard]] const nsVec3Template<Type> CrossRH(const nsVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise minimum of *this and rhs
  [[nodiscard]] const nsVec3Template<Type> CompMin(const nsVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise maximum of *this and rhs
  [[nodiscard]] const nsVec3Template<Type> CompMax(const nsVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise clamped value of *this between low and high.
  [[nodiscard]] const nsVec3Template<Type> CompClamp(const nsVec3Template<Type>& vLow, const nsVec3Template<Type>& vHigh) const; // [tested]

  /// \brief Returns the component-wise multiplication of *this and rhs
  [[nodiscard]] const nsVec3Template<Type> CompMul(const nsVec3Template<Type>& rhs) const; // [tested]

  /// \brief Returns the component-wise division of *this and rhs
  [[nodiscard]] const nsVec3Template<Type> CompDiv(const nsVec3Template<Type>& rhs) const; // [tested]

  /// brief Returns the component-wise absolute of *this.
  [[nodiscard]] const nsVec3Template<Type> Abs() const; // [tested]
