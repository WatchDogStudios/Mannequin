...
namespace
{
  ...
  static void Initialize()
  {
    ...
    {
      alignas(alignof(TrackerDataAllocator)) static nsUInt8 TrackerDataAllocatorBuffer[sizeof(TrackerDataAllocator)];
    ...
    {
      alignas(alignof(TrackerData)) static nsUInt8 TrackerDataBuffer[sizeof(TrackerData)];
...
void nsMemoryTracker::DeregisterAllocator(nsAllocatorId allocatorId)
{
  ...
  if (uiLiveAllocations != 0 && data.m_TrackingMode > nsAllocatorTrackingMode::AllocationStatsIgnoreLeaks)
  {
