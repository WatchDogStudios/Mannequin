...
template<>
struct nsJniTraits<nsJniNullPtr>
{

  static inline bool AppendSignature(const nsJniNullPtr& object, nsStringBuilder& str)
  {
    str.Append("L");
  ...
  static inline jvalue ToValue(const nsJniNullPtr& object)
  {
    jvalue j;
    j.l = nullptr;
    return j;
  ...
  static inline nsJniClass GetRuntimeType(const nsJniNullPtr& arg)
  {
    return nsJniClass(arg.GetTypeSignature().GetData());
  }
};
