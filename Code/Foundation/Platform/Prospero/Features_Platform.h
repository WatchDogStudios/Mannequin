 ...
 */
#pragma once
#if NS_DISABLED(NS_PLATFORM_PLAYSTATION_5) || !defined(__COMPILER_PS5) \
  || !defined(__PROSPERO__)
#  error "This header should only be included on PS5"
#endif
...
#  pragma comment(lib, "libScePosix_stub_weak.a")
#  pragma comment(lib, "libScePerf_nosubmission_stub_weak.a")
#  pragma comment(lib, "libSceSysmodule_stub_weak.a")
#endif
// #include <intelilsense_prospero.h>
#undef NS_PLATFORM_LITTLE_ENDIAN
#define NS_PLATFORM_LITTLE_ENDIAN NS_ON

/// If set to 1, the POSIX file implementation will be used. Otherwise a platform specific
...
// Allow Console specific engine optimizations.
#undef NS_SUPPORTS_CONSOLE_OPTIMIZATIONS
#define NS_SUPPORTS_CONSOLE_OPTIMIZATIONS NS_ON
