...
/// \brief Same as NS_WINDOWAPP_ENTRY_POINT but should be used for applications that shall always show a console window.
...
//
// In NS_WINDOWAPP_ENTRY_POINT we use macro magic to concatenate strings in such a way that depending on whether windows.h has
...
#define _NS_WINDOWAPP_ENTRY_POINT_HINSTANCE HINSTANCE
#define _NS_WINDOWAPP_ENTRY_POINT_LPSTR LPSTR
#define _NS_WINDOWAPP_ENTRY_POINT_HINSTANCE_WINDOWS_ nsMinWindows::HINSTANCE
#define _NS_WINDOWAPP_ENTRY_POINT_LPSTR_WINDOWS_ nsMinWindows::LPSTR
...
#define NS_WINDOWAPP_ENTRY_POINT(AppClass, ...)                                                                                \
  ...
  NS_APPLICATION_ENTRY_POINT_CODE_INJECTION                                                                                    \
  int NS_WINDOWS_CALLBACK WinMain(_In_ NS_PP_CONCAT(_NS_, NS_PP_CONCAT(WINDOWAPP_ENTRY_POINT_HINSTANCE, _WINDOWS_)) hInstance, \
    _In_opt_ NS_PP_CONCAT(_NS_, NS_PP_CONCAT(WINDOWAPP_ENTRY_POINT_HINSTANCE, _WINDOWS_)) hPrevInstance,                       \
    _In_ NS_PP_CONCAT(_NS_, NS_PP_CONCAT(WINDOWAPP_ENTRY_POINT_LPSTR, _WINDOWS_)) lpCmdLine, _In_ int nCmdShow)                \
  {                                                                                                                            \
