...
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsBoxManipulatorAttribute, 1, nsRTTIDefaultAllocator<nsBoxManipulatorAttribute>)
{
  ...
  NS_BEGIN_FUNCTIONS
  {
    NS_CONSTRUCTOR_PROPERTY(const char*, float, bool),
    NS_CONSTRUCTOR_PROPERTY(const char*, float, bool, const char*),
    NS_CONSTRUCTOR_PROPERTY(const char*, float, bool, const char*, const char*),
  }
  NS_END_FUNCTIONS;
}
NS_END_DYNAMIC_REFLECTED_TYPE;
...
nsScriptableFunctionAttribute::nsScriptableFunctionAttribute(ArgType argType1 /*= In*/, const char* szArg1 /*= nullptr*/,
  ...
  ArgType argType12 /*= In*/, const char* szArg12 /*= nullptr*/)
{
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg7))
      return;
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg8))
      return;
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg9))
      return;
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg10))
      return;
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg11))
      return;
  ...
  {
    if (nsStringUtils::IsNullOrEmpty(szArg12))
      return;
...
// clang-format off
NS_BEGIN_DYNAMIC_REFLECTED_TYPE(nsRttiTypeStringAttribute, 1, nsRTTIDefaultAllocator<nsRttiTypeStringAttribute>)
{
  NS_BEGIN_PROPERTIES
  {
    NS_MEMBER_PROPERTY("BaseType", m_sBaseType),
  }
  NS_END_PROPERTIES;
  NS_BEGIN_FUNCTIONS
  {
