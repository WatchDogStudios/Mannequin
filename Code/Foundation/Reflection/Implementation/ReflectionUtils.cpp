...
#undef CALL_FUNCTOR
  ...
  struct SetComponentValueImpl
  {
    ...
    {
      NS_IGNORE_UNUSED(pVector);
      NS_IGNORE_UNUSED(uiComponent);
      NS_IGNORE_UNUSED(fValue);
      NS_ASSERT_DEBUG(false, "nsReflectionUtils::SetComponent was called with a non-vector variant '{0}'", pVector->GetType());
    }
  };
  ...
  struct SetComponentValueImpl<nsVec2Template<T>>
  {
    NS_FORCE_INLINE static void impl(nsVariant* pVector, nsUInt32 uiComponent, double fValue)
    {
      NS_ASSERT_DEBUG(uiComponent < 2, "uiComponent out of range");
  ...
  struct SetComponentValueImpl<nsVec3Template<T>>
  {
    NS_FORCE_INLINE static void impl(nsVariant* pVector, nsUInt32 uiComponent, double fValue)
    {
      NS_ASSERT_DEBUG(uiComponent < 3, "uiComponent out of range");
  ...
  struct SetComponentValueImpl<nsVec4Template<T>>
  {
    NS_FORCE_INLINE static void impl(nsVariant* pVector, nsUInt32 uiComponent, double fValue)
    {
      NS_ASSERT_DEBUG(uiComponent < 4, "uiComponent out of range");
  ...
  {
    NS_FORCE_INLINE static void impl(const nsVariant* pVector, nsUInt32 uiComponent, double& out_fValue)
    {
      NS_IGNORE_UNUSED(pVector);
      NS_IGNORE_UNUSED(uiComponent);
      NS_IGNORE_UNUSED(out_fValue);
      NS_ASSERT_DEBUG(false, "nsReflectionUtils::SetComponent was called with a non-vector variant '{0}'", pVector->GetType());
    }
  };
