...
#define NS_FUNCTION_PROPERTY(Function) (new nsFunctionProperty<decltype(&OwnType::Function)>(NS_PP_STRINGIFY(Function), &OwnType::Function))
...
// [internal] Helper macro
#define NS_ENUM_VALUE_TO_CONSTANT_PROPERTY(name) NS_CONSTANT_PROPERTY(NS_PP_STRINGIFY(name), (Storage)name),
...
#define NS_ENUM_CONSTANT(Value) NS_CONSTANT_PROPERTY(NS_PP_STRINGIFY(Value), (Storage)Value)
...
#define NS_BITFLAGS_CONSTANT(Value) NS_CONSTANT_PROPERTY(NS_PP_STRINGIFY(Value), (Storage)Value)
...
#define NS_BEGIN_STATIC_REFLECTED_ENUM(Type, Version)                          \
  NS_BEGIN_STATIC_REFLECTED_TYPE(Type, nsEnumBase, Version, nsRTTINoAllocator) \
    ...
    NS_BEGIN_PROPERTIES                                                        \
      {                                                                        \
        NS_CONSTANT_PROPERTY(NS_PP_STRINGIFY(Type::Default), (Storage)Type::Default),
