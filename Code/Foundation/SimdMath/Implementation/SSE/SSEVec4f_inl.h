...
#else
  return nsSimdVec4f(floorf(static_cast<float>(x()) + 0.5f), floorf(static_cast<float>(y()) + 0.5f), floorf(static_cast<float>(z()) + 0.5f), floorf(static_cast<float>(w()) + 0.5f));
#endif
}
...
#else
  return nsSimdVec4f(floorf(static_cast<float>(x())), floorf(static_cast<float>(y())), floorf(static_cast<float>(z())), floorf(static_cast<float>(w())));
#endif
}
...
#else
  return nsSimdVec4f(ceilf(static_cast<float>(x())), ceilf(static_cast<float>(y())), ceilf(static_cast<float>(z())), ceilf(static_cast<float>(w())));
#endif
}
...
#else
  return nsSimdVec4f(int(x()), int(y()), int(z()), int(w()));
  return {};
#endif
}
