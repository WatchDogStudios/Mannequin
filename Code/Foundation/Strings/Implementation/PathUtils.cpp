...
nsStringView nsPathUtils::GetWithoutExtension(nsStringView sPath, bool bRemoveFullExtension)
{
  // TODO: unit test
...
const char nsPathUtils::OsSpecificPathSeparator = NS_PLATFORM_PATH_SEPARATOR;
