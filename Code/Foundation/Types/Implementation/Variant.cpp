...
static_assert(sizeof(nsVariant) == 24);
#else
static_assert(sizeof(nsVariant) == 20);
#endif
...
struct ComputeHashFunc
{
  ...
  {
    NS_IGNORE_UNUSED(v);
    static_assert(sizeof(typename nsVariant::TypeDeduction<T>::StorageType) <= sizeof(float) * 4 &&
