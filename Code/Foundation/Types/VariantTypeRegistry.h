...
#define NS_DEFINE_CUSTOM_VARIANT_TYPE(TYPE)                                                                                                                         \
  static_assert(nsVariantTypeDeduction<TYPE>::value == nsVariantType::TypedObject, "NS_DECLARE_CUSTOM_VARIANT_TYPE needs to be added to the header defining TYPE"); \
