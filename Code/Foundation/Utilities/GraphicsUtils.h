...
namespace nsGraphicsUtils
{
  ...
  NS_FOUNDATION_DLL void ConvertScreenPixelPosToNormalizedPos(const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, nsVec3& inout_vPixelPos);

  /// \brief Converts a screen-space position from normalized coordinates to pixel coordinates.
  NS_FOUNDATION_DLL void ConvertScreenNormalizedPosToPixelPos(const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, nsVec3& inout_vNormalizedPos);
  ...
  NS_FOUNDATION_DLL nsResult ConvertWorldPosToScreenPos(const nsMat4& mModelViewProjection, const nsVec3& vPoint, nsVec3& out_vScreenPosNormalized,
    nsClipSpaceDepthRange::Enum depthRange = nsClipSpaceDepthRange::Default); // [tested]
  ...
  NS_FOUNDATION_DLL nsResult ConvertScreenPosToWorldPos(const nsMat4& mInverseModelViewProjection, const nsUInt32 uiViewportX,
    const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, const nsVec3& vScreenPixelPos, nsVec3& out_vPoint,
    nsVec3* out_pDirection = nullptr, nsClipSpaceDepthRange::Enum depthRange = nsClipSpaceDepthRange::Default); // [tested]
  ...
  NS_FOUNDATION_DLL nsResult ConvertScreenPosToWorldPos(const nsMat4& mInverseModelViewProjection, const nsVec3& vNormalizedScreenPos, nsVec3& out_vPoint,
    nsVec3* out_pDirection = nullptr, nsClipSpaceDepthRange::Enum depthRange = nsClipSpaceDepthRange::Default); // [tested]
  ...
  NS_FOUNDATION_DLL nsResult ConvertScreenPosToWorldPos(const nsMat4d& mInverseModelViewProjection, const nsVec3& vNormalizedScreenPos,
    nsVec3& out_vPoint, nsVec3* out_pDirection = nullptr, nsClipSpaceDepthRange::Enum depthRange = nsClipSpaceDepthRange::Default); // [tested]
  ...
  NS_FOUNDATION_DLL void ConvertProjectionMatrixDepthRange(nsMat4& inout_mMatrix, nsClipSpaceDepthRange::Enum srcDepthRange, nsClipSpaceDepthRange::Enum dstDepthRange); // [tested]
  ...
  NS_FOUNDATION_DLL nsMat3 CreateLookAtViewMatrix(const nsVec3& vTarget, const nsVec3& vUpDir, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]

  /// \brief Same as CreateLookAtViewMatrix() but returns the inverse matrix
  NS_FOUNDATION_DLL nsMat3 CreateInverseLookAtViewMatrix(const nsVec3& vTarget, const nsVec3& vUpDir, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]
  ...
  /// \brief Same as CreateLookAtViewMatrix() but returns the inverse matrix
  NS_FOUNDATION_DLL nsMat4 CreateInverseLookAtViewMatrix(const nsVec3& vEyePos, const nsVec3& vLookAtPos, const nsVec3& vUpDir, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]
  ...
  NS_FOUNDATION_DLL nsMat4 CreateViewMatrix(const nsVec3& vPosition, const nsVec3& vForwardDir, const nsVec3& vRightDir, const nsVec3& vUpDir, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]

  /// \brief Similar to CreateViewMatrix() but creates the inverse matrix.
  NS_FOUNDATION_DLL nsMat4 CreateInverseViewMatrix(const nsVec3& vPosition, const nsVec3& vForwardDir, const nsVec3& vRightDir, const nsVec3& vUpDir, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]
  ...
  NS_FOUNDATION_DLL void DecomposeViewMatrix(nsVec3& out_vPosition, nsVec3& out_vForwardDir, nsVec3& out_vRightDir, nsVec3& out_vUpDir, const nsMat4& mViewMatrix, nsHandedness::Enum handedness = nsHandedness::Default); // [tested]
