...
void nsGraphicsUtils::ConvertScreenPixelPosToNormalizedPos(const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, nsVec3& inout_vPixelPos)
{
...
void nsGraphicsUtils::ConvertScreenNormalizedPosToPixelPos(const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, nsVec3& inout_vNormalizedPos)
{
...
{
  NS_SUCCEED_OR_RETURN(ConvertWorldPosToScreenPos(mModelViewProjection, vPoint, out_vScreenPos, depthRange));
...
nsResult nsGraphicsUtils::ConvertWorldPosToScreenPos(const nsMat4& mModelViewProjection, const nsVec3& vPoint, nsVec3& out_vScreenPosNormalized, nsClipSpaceDepthRange::Enum depthRange /*= nsClipSpaceDepthRange::Default*/)
{
...
nsResult nsGraphicsUtils::ConvertScreenPosToWorldPos(const nsMat4& mInverseModelViewProjection, const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, const nsVec3& vScreenPixelPos, nsVec3& out_vPoint, nsVec3* out_pDirection, nsClipSpaceDepthRange::Enum depthRange)
{
  nsVec3 vNormalizedScreenPos = vScreenPixelPos;
  ...
  return nsGraphicsUtils::ConvertScreenPosToWorldPos(mInverseModelViewProjection, vNormalizedScreenPos, out_vPoint, out_pDirection, depthRange);
}

nsResult nsGraphicsUtils::ConvertScreenPosToWorldPos(const nsMat4& mInverseModelViewProjection, const nsVec3& vNormalizedScreenPos, nsVec3& out_vPoint, nsVec3* out_pDirection /*= nullptr*/, nsClipSpaceDepthRange::Enum depthRange /*= nsClipSpaceDepthRange::Default*/)
{
  nsVec3 vClipSpace = vNormalizedScreenPos;
...
nsResult nsGraphicsUtils::ConvertScreenPosToWorldPos(const nsMat4d& mInverseModelViewProjection, const nsUInt32 uiViewportX, const nsUInt32 uiViewportY, const nsUInt32 uiViewportWidth, const nsUInt32 uiViewportHeight, const nsVec3& vScreenPixelPos, nsVec3& out_vPoint, nsVec3* out_pDirection /*= nullptr*/,
...
nsResult nsGraphicsUtils::ConvertScreenPosToWorldPos(const nsMat4d& mInverseModelViewProjection, const nsVec3& vNormalizedScreenPos, nsVec3& out_vPoint, nsVec3* out_pDirection /*= nullptr*/, nsClipSpaceDepthRange::Enum depthRange /*= nsClipSpaceDepthRange::Default*/)
{
  nsVec3 vClipSpace = vNormalizedScreenPos;
