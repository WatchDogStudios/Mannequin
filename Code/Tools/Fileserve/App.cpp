...
void nsFileserverApp::AfterCoreSystemsStartup()
{
  ...
  nsPlugin::LoadPlugin("nsShaderCompilerDXC", nsPluginLoadFlags::PluginIsOptional).IgnoreResult();
  nsPlugin::LoadPlugin("nsShaderCompilerHLSL", nsPluginLoadFlags::PluginIsOptional).IgnoreResult();
