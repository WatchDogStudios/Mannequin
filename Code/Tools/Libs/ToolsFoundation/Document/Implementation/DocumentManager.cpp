  ...
  nsBitflags<nsDocumentFlags> flags, const nsDocumentObject* pOpenContext /*= nullptr*/)
{
  ...
  return nsStatus("Not implemented");
#endif
}

nsStatus nsDocumentManager::CreateDocument(nsStringView sDocumentTypeName, nsStringView sPath, nsDocument*& out_pDocument, nsBitflags<nsDocumentFlags> flags, const nsDocumentObject* pOpenContext)
{
