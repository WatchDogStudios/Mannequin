...
namespace
{
  ...
  nsExpressionFunction s_TestFunc1 = {
    {nsMakeHashedString("TestFunc"), nsExpression::FunctionDesc::TypeList(s_TestFunc1InputTypes), 2, nsExpression::RegisterType::Float},
    &TestFunc1,
  };

  nsExpressionFunction s_TestFunc2 = {
    {nsMakeHashedString("TestFunc"), nsExpression::FunctionDesc::TypeList(s_TestFunc2InputTypes), 3, nsExpression::RegisterType::Float},
    &TestFunc2,
  };
...
NS_CREATE_SIMPLE_TEST(CodeUtils, Expression)
{
  ...
  NS_TEST_BOOL(nsFileSystem::AddDataDirectory(outputPath.GetData(), "test", "output", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
