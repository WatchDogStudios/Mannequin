...
NS_CREATE_SIMPLE_TEST(Configuration, CVars)
{
  ...
  NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder1.GetData(), "test", "output", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "SaveCVarsToFile and LoadCVarsFromFile again")
  {
    ...
    NS_TEST_BOOL_MSG(nsFileSystem::AddDataDirectory(cvarConfigFileDir, "CVarsTest", "CVarConfigTempDir", nsDataDirUsage::AllowWrites) == NS_SUCCESS, "Failed to mount data dir '%s'", cvarConfigFileDir);
