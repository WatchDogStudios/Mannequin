...
void DirectoryWatcherTest()
{
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "git")
  {
    ...
    NS_TEST_BOOL(watcher.OpenDirectory(sTestRootPath, nsDirectoryWatcher::Watch::Creates | nsDirectoryWatcher::Watch::Writes | nsDirectoryWatcher::Watch::Deletes | nsDirectoryWatcher::Watch::Renames | nsDirectoryWatcher::Watch::Subdirectories).Succeeded());
    ...
    ExpectedEvent expectedEvents[] = {
      {"index.lock", nsDirectoryWatcherAction::Added, nsDirectoryWatcherType::File},
      {"index", nsDirectoryWatcherAction::Removed, nsDirectoryWatcherType::File},
      {"index.lock", nsDirectoryWatcherAction::RenamedOldName, nsDirectoryWatcherType::File},
      {"index", nsDirectoryWatcherAction::RenamedNewName, nsDirectoryWatcherType::File},
...
NS_CREATE_SIMPLE_TEST(IO, DirectoryWatcherNonNTFS)
{
