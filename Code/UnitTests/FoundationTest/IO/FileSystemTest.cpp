...
...";
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Setup Data Dirs")
  {
    ...
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(szOutputFolder, "Clear", "output", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
    ...
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder1, "Clear", "output1", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder2, "Clear") == NS_SUCCESS);

    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder2, "Remove", "output2", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
    ...
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder1, "", "output1", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
  ...
  {
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory("", "xyz-rooted", "xyz", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
  ...
  {
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(szOutputFolder, "remove", "toplevel", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
    NS_TEST_BOOL(nsFileSystem::AddDataDirectory(sOutputFolder2, "remove", "output2", nsDataDirUsage::AllowWrites) == NS_SUCCESS);
