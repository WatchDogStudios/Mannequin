...
private:
  ...
  virtual nsResult InitializeTest() override
  {
    ...
    nsFileSystem::AddDataDirectory(">nstest/", "ImageComparisonDataDir", "imgout", nsDataDirUsage::AllowWrites).IgnoreResult();

    nsStringBuilder overrideFolder("Images_Reference_", NS_PLATFORM_NAME);
    ...
    nsTestFramework::GetInstance()->SetImageReferenceOverrideFolderName(overrideFolder);
