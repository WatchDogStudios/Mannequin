...
NS_CREATE_SIMPLE_TEST(Math, General)
{
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "FloorToInt")
  {
    NS_TEST_BOOL(12 == nsMath::FloorToInt(12.34f));
    NS_TEST_BOOL(-13 == nsMath::FloorToInt(-12.34f));
  }

  NS_TEST_BLOCK(nsTestBlock::Enabled, "CeilToInt")
  {
    NS_TEST_BOOL(13 == nsMath::CeilToInt(12.34f));
    NS_TEST_BOOL(-12 == nsMath::CeilToInt(-12.34f));
  }
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "RoundToInt")
  {
    NS_TEST_BOOL(nsMath::RoundToInt(12.34f) == 12);
    NS_TEST_BOOL(nsMath::RoundToInt(-12.34f) == -12);

    NS_TEST_BOOL(nsMath::RoundToInt(12.54f) == 13);
    NS_TEST_BOOL(nsMath::RoundToInt(-12.54f) == -13);
  }
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "GreatestCommonDivisor")
  {
    ...
    NS_TEST_INT(nsMath::GreatestCommonDivisor(13, 0), 13);
    NS_TEST_INT(nsMath::GreatestCommonDivisor(0, 637), 637);
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "WrapUInt")
  {
    NS_TEST_INT(nsMath::WrapUInt(0, 5), 0);
    NS_TEST_INT(nsMath::WrapUInt(1, 5), 1);
    NS_TEST_INT(nsMath::WrapUInt(2, 5), 2);
    NS_TEST_INT(nsMath::WrapUInt(3, 5), 3);
    NS_TEST_INT(nsMath::WrapUInt(4, 5), 4);
    NS_TEST_INT(nsMath::WrapUInt(5, 5), 0);
    NS_TEST_INT(nsMath::WrapUInt(6, 5), 1);

    NS_TEST_INT(nsMath::WrapUInt(0, 1), 0);
    NS_TEST_INT(nsMath::WrapUInt(1, 1), 0);
    NS_TEST_INT(nsMath::WrapUInt(2, 1), 0);

    NS_TEST_INT(nsMath::WrapUInt(0, 2), 0);
    NS_TEST_INT(nsMath::WrapUInt(1, 2), 1);
    NS_TEST_INT(nsMath::WrapUInt(2, 2), 0);
    NS_TEST_INT(nsMath::WrapUInt(3, 2), 1);
  }

  NS_TEST_BLOCK(nsTestBlock::Enabled, "WrapInt")
  {
    NS_TEST_INT(nsMath::WrapInt(0, 5), 0);
    NS_TEST_INT(nsMath::WrapInt(1, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(2, 5), 2);
    NS_TEST_INT(nsMath::WrapInt(3, 5), 3);
    NS_TEST_INT(nsMath::WrapInt(4, 5), 4);
    NS_TEST_INT(nsMath::WrapInt(5, 5), 0);
    NS_TEST_INT(nsMath::WrapInt(6, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(7, 5), 2);

    NS_TEST_INT(nsMath::WrapInt(-1, 5), 4);
    NS_TEST_INT(nsMath::WrapInt(-2, 5), 3);
    NS_TEST_INT(nsMath::WrapInt(-4, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(-5, 5), 0);
    NS_TEST_INT(nsMath::WrapInt(-6, 5), 4);
  }

  NS_TEST_BLOCK(nsTestBlock::Enabled, "WrapInt (min, max)")
  {
    NS_TEST_INT(nsMath::WrapInt(0, 1, 5), 4);
    NS_TEST_INT(nsMath::WrapInt(1, 1, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(2, 1, 5), 2);
    NS_TEST_INT(nsMath::WrapInt(3, 1, 5), 3);
    NS_TEST_INT(nsMath::WrapInt(4, 1, 5), 4);
    NS_TEST_INT(nsMath::WrapInt(5, 1, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(6, 1, 5), 2);
    NS_TEST_INT(nsMath::WrapInt(7, 1, 5), 3);

    NS_TEST_INT(nsMath::WrapInt(-1, 1, 5), 3);
    NS_TEST_INT(nsMath::WrapInt(-2, 1, 5), 2);
    NS_TEST_INT(nsMath::WrapInt(-3, 1, 5), 1);
    NS_TEST_INT(nsMath::WrapInt(-4, 1, 5), 4);
    NS_TEST_INT(nsMath::WrapInt(-5, 1, 5), 3);
    NS_TEST_INT(nsMath::WrapInt(-6, 1, 5), 2);

    NS_TEST_INT(nsMath::WrapInt(-5, -5, -2), -5);
    NS_TEST_INT(nsMath::WrapInt(-6, -5, -2), -3);
    NS_TEST_INT(nsMath::WrapInt(-7, -5, -2), -4);
    NS_TEST_INT(nsMath::WrapInt(-8, -5, -2), -5);

    NS_TEST_INT(nsMath::WrapInt(0, -5, -2), -3);
  }

  NS_TEST_BLOCK(nsTestBlock::Enabled, "WrapFloat01")
  {
    NS_TEST_FLOAT(nsMath::WrapFloat01(0.0f), 0.0f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(0.5f), 0.5f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(1.0f), 1.0f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(1.1f), 0.1f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(1.7f), 0.7f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(2.0f), 1.0f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(2.2f), 0.2f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(-0.2f), 0.8f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(-0.9f), 0.1f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(-1.0f), 0.0f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(-1.1f), 0.9f, 0.0000001f);
    NS_TEST_FLOAT(nsMath::WrapFloat01(-1.01f), 0.99f, 0.0000001f);
  }

  NS_TEST_BLOCK(nsTestBlock::Enabled, "WrapFloat")
  {
    NS_TEST_FLOAT(nsMath::WrapFloat(3.5f, 3.5f, 5.7f), 3.5f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(5.0f, 3.5f, 5.7f), 5.0f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(5.7f, 3.5f, 5.7f), 5.7f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(5.8f, 3.5f, 5.7f), 3.6f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(3.4f, 3.5f, 5.7f), 5.6f, 0.00001f);

    NS_TEST_FLOAT(nsMath::WrapFloat(-1.2f, -1.2f, 0.5f), -1.2f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(0.0f, -1.2f, 0.5f), 0.0f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(0.5f, -1.2f, 0.5f), 0.5f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(0.6f, -1.2f, 0.5f), -1.1f, 0.00001f);
    NS_TEST_FLOAT(nsMath::WrapFloat(-1.3f, -1.2f, 0.5f), 0.4f, 0.00001f);
  }
}
