...
#  endif
    ...
    static_assert(sizeof(nsSimdVec4f) == 16);
    static_assert(alignof(nsSimdVec4f) == 16);
#endif
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Functions")
  {
...

    {
      ...
      NS_TEST_BOOL(a.IsValid<1>());
      NS_TEST_BOOL(a.IsValid<2>());
      NS_TEST_BOOL(a.IsValid<3>());
      NS_TEST_BOOL(a.IsValid<4>());
    }
  }
  ...
  NS_TEST_BLOCK(nsTestBlock::Enabled, "GetCombined")
  {
    nsSimdVec4f a(2.0f, 4.0f, 6.0f, 8.0f);
    nsSimdVec4f b(3.0f, 5.0f, 7.0f, 9.0f);

    nsSimdVec4f c = a.GetCombined<nsSwizzle::XXXX>(b);
    NS_TEST_BOOL(c.x() == a.x() && c.y() == a.x() && c.z() == b.x() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::YYYX>(b);
    NS_TEST_BOOL(c.x() == a.y() && c.y() == a.y() && c.z() == b.y() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::ZZZX>(b);
    NS_TEST_BOOL(c.x() == a.z() && c.y() == a.z() && c.z() == b.z() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::WWWX>(b);
    NS_TEST_BOOL(c.x() == a.w() && c.y() == a.w() && c.z() == b.w() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::WZYX>(b);
    NS_TEST_BOOL(c.x() == a.w() && c.y() == a.z() && c.z() == b.y() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::XYZW>(b);
    NS_TEST_BOOL(c.x() == a.x() && c.y() == a.y() && c.z() == b.z() && c.w() == b.w());

    c = a.GetCombined<nsSwizzle::WZYX>(b);
    NS_TEST_BOOL(c.x() == a.w() && c.y() == a.z() && c.z() == b.y() && c.w() == b.x());

    c = a.GetCombined<nsSwizzle::YYYY>(b);
    NS_TEST_BOOL(c.x() == a.y() && c.y() == a.y() && c.z() == b.y() && c.w() == b.y());
  }
