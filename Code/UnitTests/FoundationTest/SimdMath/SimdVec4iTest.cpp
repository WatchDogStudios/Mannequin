...
NS_CREATE_SIMPLE_TEST(SimdMath, SimdVec4i)
{
  NS_TEST_BLOCK(nsTestBlock::Enabled, "Constructor")
  {
    ...
    static_assert(sizeof(nsSimdVec4i) == 16);
    static_assert(alignof(nsSimdVec4i) == 16);
#endif
  ...
  {
    nsSimdVec4i a(2, 4, 6, 8);
    nsSimdVec4i b(3, 5, 7, 9);

    nsSimdVec4i c = a.GetCombined<nsSwizzle::XXXX>(b);
