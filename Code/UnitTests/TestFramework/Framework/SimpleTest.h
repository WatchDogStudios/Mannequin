...
#define NS_CREATE_SIMPLE_TEST_GROUP(GroupName) nsSimpleTestGroup NS_PP_CONCAT(g_SimpleTestGroup__, GroupName)(NS_PP_STRINGIFY(GroupName));

#define NS_CREATE_SIMPLE_TEST(GroupName, TestName)                                                                             \
  extern nsSimpleTestGroup NS_PP_CONCAT(g_SimpleTestGroup__, GroupName);                                                       \
  ...
  nsRegisterSimpleTestHelper nsRegisterSimpleTest__##GroupName##TestName(                                                      \
    &NS_PP_CONCAT(g_SimpleTestGroup__, GroupName), NS_PP_STRINGIFY(TestName), nsSimpleTestFunction__##GroupName##_##TestName); \
  static void nsSimpleTestFunction__##GroupName##_##TestName()
