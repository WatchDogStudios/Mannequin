...
public:
  ...
  virtual nsTestAppRun RunTests() { return RunTestExecutionLoop(); }
...
#define NS_TEST_BOOL_MSG(condition, msg, ...) \
  nsTestBool(condition, "Test failed: " NS_PP_STRINGIFY(condition), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, msg, ##__VA_ARGS__)
...
#define NS_TEST_RESULT_MSG(condition, msg, ...) \
  nsTestResult(condition, "Test failed: " NS_PP_STRINGIFY(condition), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, msg, ##__VA_ARGS__)
...
#define NS_TEST_STATUS(condition)                    \
  auto NS_PP_CONCAT(l_, NS_SOURCE_LINE) = condition; \
  nsTestResult(NS_PP_CONCAT(l_, NS_SOURCE_LINE).m_Result, "Test failed: " NS_PP_STRINGIFY(condition), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, NS_PP_CONCAT(l_, NS_SOURCE_LINE).m_sMessage)
...
#define NS_TEST_FLOAT_MSG(f1, f2, epsilon, msg, ...)                                                                                                     \
  nsTestDouble(ToFloat(f1), ToFloat(f2), ToFloat(epsilon), NS_PP_STRINGIFY(f1), NS_PP_STRINGIFY(f2), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, \
    msg, ##__VA_ARGS__)
...
#define NS_TEST_INT_MSG(i1, i2, msg, ...) \
  nsTestInt(i1, i2, NS_PP_STRINGIFY(i1), NS_PP_STRINGIFY(i2), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, msg, ##__VA_ARGS__)
...
#define NS_TEST_STRING_MSG(s1, s2, msg, ...)                                                                                                           \
  nsTestString(static_cast<nsStringView>(s1), static_cast<nsStringView>(s2), NS_PP_STRINGIFY(s1), NS_PP_STRINGIFY(s2), NS_SOURCE_FILE, NS_SOURCE_LINE, \
...
#define NS_TEST_WSTRING_MSG(s1, s2, msg, ...)                                                                                               \
  nsTestWString(static_cast<const wchar_t*>(s1), static_cast<const wchar_t*>(s2), NS_PP_STRINGIFY(s1), NS_PP_STRINGIFY(s2), NS_SOURCE_FILE, \
...
#define NS_TEST_VEC2_MSG(r1, r2, epsilon, msg, ...)                                                                                \
  nsTestVector(nsVec4d(ToFloat((r1).x), ToFloat((r1).y), 0, 0), nsVec4d(ToFloat((r2).x), ToFloat((r2).y), 0, 0), ToFloat(epsilon), \
    NS_PP_STRINGIFY(r1) " == " NS_PP_STRINGIFY(r2), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, msg, ##__VA_ARGS__)
...
#define NS_TEST_VEC3_MSG(r1, r2, epsilon, msg, ...)                                                                                          \
  nsTestVector(nsVec4d(ToFloat((r1).x), ToFloat((r1).y), ToFloat((r1).z), 0), nsVec4d(ToFloat((r2).x), ToFloat((r2).y), ToFloat((r2).z), 0), \
    ToFloat(epsilon), NS_PP_STRINGIFY(r1) " == " NS_PP_STRINGIFY(r2), NS_SOURCE_FILE, NS_SOURCE_LINE, NS_SOURCE_FUNCTION, msg, ##__VA_ARGS__)
...
#define NS_TEST_VEC4_MSG(r1, r2, epsilon, msg, ...)                                                                                                \
  nsTestVector(nsVec4d(ToFloat((r1).x), ToFloat((r1).y), ToFloat((r1).z), ToFloat((r1).w)),                                                        \
    nsVec4d(ToFloat((r2).x), ToFloat((r2).y), ToFloat((r2).z), ToFloat((r2).w)), ToFloat(epsilon), NS_PP_STRINGIFY(r1) " == " NS_PP_STRINGIFY(r2), \
