...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// WDSC_INT128_INTRINSIC_AVAILABLE
//
#if (WDSC_COMPILER_INTMAX_SIZE >= 16) && (defined(WDSC_COMPILER_GNUC) || defined(WDSC_COMPILER_CLANG))
	// __int128_t/__uint128_t is supported
	#define WDSC_INT128_INTRINSIC_AVAILABLE 1 
#else
	#define WDSC_INT128_INTRINSIC_AVAILABLE 0
#endif

///////////////////////////////////////////////////////////////////////////////////////////////////////
// WDSC_INT128_ALIGNAS
//
#if WDSC_INT128_INTRINSIC_AVAILABLE && !defined(WDSC_COMPILER_NO_ALIGNAS)
	#define WDSC_INT128_ALIGNAS alignas(unsigned __int128)
#else
	#define WDSC_INT128_ALIGNAS
#endif
...
//
#define WDSC_HAVE_INT128 1


///////////////////////////////////////////////////////////////////////////////////////////////////////
// uint128_t_base
//
struct WDSC_INT128_ALIGNAS int128_t_base
{
	...
	WDSC_CONSTEXPR explicit operator bool() const;
	WDSC_CONSTEXPR explicit operator char() const;
	WDSC_CONSTEXPR explicit operator int() const;
	WDSC_CONSTEXPR explicit operator long() const; 
	WDSC_CONSTEXPR explicit operator long long() const;
	WDSC_CONSTEXPR explicit operator short() const; 
	WDSC_CONSTEXPR explicit operator signed char() const;
	WDSC_CONSTEXPR explicit operator unsigned char() const;
	WDSC_CONSTEXPR explicit operator unsigned int() const;
	WDSC_CONSTEXPR explicit operator unsigned long long() const;
	WDSC_CONSTEXPR explicit operator unsigned long() const;
	WDSC_CONSTEXPR explicit operator unsigned short() const;
#if WDSC_WCHAR_UNIQUE
	// WDSC_CONSTEXPR explicit operator char16_t() const;
	// WDSC_CONSTEXPR explicit operator char32_t() const;
	// WDSC_CONSTEXPR explicit operator wchar_t() const;
#endif
	WDSC_CONSTEXPR explicit operator float() const;
	WDSC_CONSTEXPR explicit operator double() const;
	WDSC_CONSTEXPR explicit operator long double() const;
#if WDSC_INT128_INTRINSIC_AVAILABLE
	WDSC_CONSTEXPR explicit operator __int128() const;
	WDSC_CONSTEXPR explicit operator unsigned __int128() const;
#endif
...
protected:
	...
	WDSC_CONSTEXPR uint64_t Low() const
	{
		return mPart0;
	}

	WDSC_CONSTEXPR uint64_t High() const
	{
		return mPart1;
	}

protected:
	#ifdef WDSC_SYSTEM_BIG_ENDIAN
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
WDSC_CONSTEXPR inline int128_t_base::operator bool() const               { return mPart0 || mPart1; }
WDSC_CONSTEXPR inline int128_t_base::operator char() const               { return static_cast<char>(Low()); }
#if WDSC_WCHAR_UNIQUE
// WDSC_CONSTEXPR inline int128_t_base::operator char16_t() const           { return static_cast<char16_t>(Low()); }
// WDSC_CONSTEXPR inline int128_t_base::operator char32_t() const           { return static_cast<char32_t>(Low()); }
// WDSC_CONSTEXPR inline int128_t_base::operator wchar_t() const            { return static_cast<wchar_t>(Low()); }
#endif
WDSC_CONSTEXPR inline int128_t_base::operator int() const                { return static_cast<int>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator long() const               { return static_cast<long>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator long long() const          { return static_cast<long long>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator short() const              { return static_cast<short>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator signed char() const        { return static_cast<signed char>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned char() const      { return static_cast<unsigned char>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned int() const       { return static_cast<unsigned int>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned long long() const { return static_cast<unsigned long long>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned long() const	   { return static_cast<unsigned long>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned short() const     { return static_cast<unsigned short>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator float() const              { return static_cast<float>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator double() const             { return static_cast<double>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator long double() const        { return static_cast<long double>(Low()); }
#if WDSC_INT128_INTRINSIC_AVAILABLE
WDSC_CONSTEXPR inline int128_t_base::operator __int128() const           { return static_cast<__int128>(Low()); }
WDSC_CONSTEXPR inline int128_t_base::operator unsigned __int128() const  { return static_cast<unsigned __int128>(Low()); }
#endif

inline void int128_t_base::SetBit(int nIndex, int value)
{
	// WDSC_ASSERT((nIndex >= 0) && (nIndex < 128));
...
inline void int128_t_base::DoubleToUint128(double value)
{
	...
	// WDSC_ASSERT(fabs(value) < 18446744073709551616.0); // Assert that the input is <= 64 bits of integer.
...
WDSC_DISABLE_VC_WARNING(4723) // warning C4723: potential divide by 0
...
// would work.
//
/* WDSC_CONSTEXPR */ inline uint128_t UINT128_C(uint64_t nPart1, uint64_t nPart0) { return uint128_t(nPart0, nPart1); }
/* WDSC_CONSTEXPR */ inline int128_t INT128_C(int64_t nPart1, int64_t nPart0) { return int128_t(static_cast<uint64_t>(nPart0), static_cast<uint64_t>(nPart1)); }
