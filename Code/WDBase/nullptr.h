...
#if defined(WDSC_COMPILER_CPP11_ENABLED) && !defined(WDSC_COMPILER_NO_NULLPTR) && !defined(WDSC_HAVE_nullptr_t_IMPL)
...
#if defined(WDSC_COMPILER_NO_NULLPTR) // If the compiler lacks a native version... 
...
#endif // WDSC_COMPILER_NO_NULLPTR
